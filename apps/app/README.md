...
This is the app part of the template - where our good old friend Electron is residing.
...
1. `npm run dev`
2. ...
3. The app project should now have opened an Electron app
...
1. `npm run build`
2. ...
3. The app folder should now contain a `dist` folder if everything went as expected.
